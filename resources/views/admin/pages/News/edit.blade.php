...
<div class="main-panel">
    <div class="content-wrapper">
        ...
        <div class="container">
            <!-- form start -->
                <form action=" {{route('news.update', $Id)}} " method="POST" enctype="multipart/form-data" onsubmit="return CheckInput();">
                @csrf
                <div class="row">
                  <div class="col-lg-6">
                    <label for="exampleInputTitle">Tiêu đề</label>
                    <input class="form-control" type="text" name="Tieu_De" id="Tieu_De" placeholder="Tiêu đề" value="{{ $Tieu_De }}">
                  </div>
                  <div class="col-lg-6">
                ...
                <div class="row">
                  <div class="col-lg-12">
                    ...
                    <textarea type="text" style="height:100px" class="form-control" name="Noi_Dung" id="editor" placeholder="Nhập nội dung bài viết">{!! $Noi_Dung !!}</textarea>
                  </div>
                </div>
