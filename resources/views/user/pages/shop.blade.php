					...
					<div class="row">
						...
						<div class="side-bar col-lg-3">
							...
							<div class="deal-leftmk left-side">
								...
								@foreach($book_new as $b_new)
								<div class="special-sec1">
									<div class="img-deals">
										<img src="{!! asset($b_new->Anh_Bia) !!}" alt="">
									</div>
									<div class="img-deal1">
										<h3 class="hidden">{{$b_new->Ten_Sach}}</h3>
										<a href="{{ route('user.single',$b_new->Id)}}">{{number_format($b_new->Gia_Tien).' '. 'VNĐ'}}</a>
									</div>
									<div class="clearfix"></div>
								</div>
								@endforeach
				...
				<div class="slider-img mid-sec mt-lg-5 mt-2 px-lg-5 px-3">
						...
						<div class="mid-slider">
							<div class="owl-carousel owl-theme row">
								@foreach($sach_noi_bat as $noibat)
								<div class="item">
									<div class="gd-box-info text-center">
										<div class="product-men women_two bot-gd">
											<div class="product-googles-info slide-img googles">
												<div class="men-pro-item">
													<div class="men-thumb-item">
														<img src="{!! asset($noibat->Anh_Bia) !!}" class="img-fluid" alt="">
														<div class="men-cart-pro">
															<div class="inner-men-cart-pro">
																<a href="{{ route('user.single',$noibat->Id)}}" class="link-product-add-cart">Chi tiết</a>
															</div>
														</div>
													...
													<div class="item-info-product">
														...
														<div class="info-product-price">
															<div class="grid_meta">
																<div class="product_price">
																	<h4 class="hidden">
																		<a href="{{ route('user.single',$noibat->Id)}}">{{$noibat->Ten_Sach}} </a>
																	</h4>
																	<div class="grid-price mt-2">
																		<span class="money ">{{number_format($noibat->Gia_Tien).' '. 'VNĐ'}}</span>
																	</div>
																</div>
																<ul class="stars">
																	<li>
